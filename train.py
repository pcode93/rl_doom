...
from env.util import all_actions, default_actions_for_map, default_reward_shaping
...
def train():
    ...
    parser.add_argument('--state_rgb', dest='rgb', default=False, action='store_true',
                        help='whether to use rgb or gray frames')
    parser.add_argument('--shape_rewards', dest='shape_rewards', default=False, action='store_true',
                        help='whether to use a reward shaping function specified for the selected map')
    ...
    parser.add_argument('--dqn_use_ddqn', dest='ddqn', default=False, action='store_true',
                        help='whether to use ddqn instead of dqn')
    parser.add_argument('--dqn_dueling', dest='dueling', default=False, action='store_true',
    ...
    reward_fn = default_reward_shaping(args.map_name) if args.shape_rewards else None
